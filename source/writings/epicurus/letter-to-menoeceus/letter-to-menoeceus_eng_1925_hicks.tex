...
\usemodule{glossary/abbreviations/en?verses}
...
\begin{sparagraph}[id=letter-to-menoeceus,name=Letter to Menoeceus]
  ...
  Much worse is he who says that \textquote[\sr{verses 425--428}{Elegies, \verses 425--428}]{it were good not to be born, but when once one is born to pass with all speed through the gates of \sn{Hades}}.
