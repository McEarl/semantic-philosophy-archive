...
\libinput{preamble}
\begin{document}
\usemodule{glossary/abbreviations?verses}
...
\metadata{
  writing={\sn{Letter to Menoeceus}},
  lang={eng},
  source={1925_Hicks_LivesAndOpinionsOfEminentPhilosophers},
  license={CC0}
}
...
Much worse is he who says that \textquote[\sn{Elegies}, \verses 425 -- 428]{it were good not to be born, but when once one is born to pass with all speed through the gates of \sn{Hades}}.
